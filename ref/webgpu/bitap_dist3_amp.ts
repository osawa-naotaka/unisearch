import cs from "@ref/webgpu/bitap_dist3_amp.wgsl?raw";

export async function run_bitap_dist3_amp(device: GPUDevice, buffers: Record<string, GPUBuffer>, name: string) {
