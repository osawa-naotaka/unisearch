import cs from "@ref/webgpu/1char_4w_uniform.wgsl?raw";

export async function run_1char_4w_uniform(device: GPUDevice, buffers: Record<string, GPUBuffer>, name: string) {
    ...
    pass.dispatchWorkgroups(buffers.data.size / 4 / 4 / 256);   // 4byte/char, vec4, 256 workgroup_size
    pass.end();
