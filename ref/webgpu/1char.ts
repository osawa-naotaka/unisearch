import cs from "@ref/webgpu/1char.wgsl?raw";

export async function run_1char(device: GPUDevice, buffers: Record<string, GPUBuffer>, name: string) {
    ...
    pass.dispatchWorkgroups(buffers.data.size / 4 / 256);
    pass.end();
