import cs from "@ref/webgpu/bitap_dist1_amp.wgsl?raw";

export async function run_bitap_dist1_amp(device: GPUDevice, buffers: Record<string, GPUBuffer>, name: string) {
