...
export function createIndex(contents: any[], key_fields: Path[] = [], search_targets: Path[] = [], field_names: FieldNameMap = {}) : UniIndex | UniSearchError {
    try {
        ...
        } else {    // indexing all, including key entries
            for(let id = 0; id < contents.length; id++) {
